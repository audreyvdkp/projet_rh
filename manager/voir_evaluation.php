...
// 🔒 Sécurité : on vérifie que cette évaluation a bien été faite par ce manager
$stmt = $pdo->prepare("
    ...
    WHERE ev.id_evaluation = ? AND ev.id_evaluateur = ?
");
$stmt->execute([$idEvaluation, $idEmployeManager]);
