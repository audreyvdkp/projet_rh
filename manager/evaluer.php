...
// Vérifier que cet employé fait bien partie de l'équipe du manager
$stmt = $pdo->prepare("
...
");
$stmt->execute([$idEmployeCible, $idEmployeManager]);
...
$scoreFinal = min($scoreFinal, 100);  
    ...
    $stmt = $pdo->prepare("
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, 'En cours')
    ");
    $stmt->execute([$idEmployeCible, $idEmployeManager, $dateEvaluation, $periodeDebut, $periodeFin, $scoreFinal, $mention]);
...
<head>
    ...
    <title>Évaluer <?= htmlspecialchars($employeCible['prenom']) ?> — Manager</title>
...
<div class="conteneur-app">
    ...
    <div class="zone-contenu">
        ...
        <div class="entete-page">
            ...
            <a href="equipe.php" class="bouton-secondaire">← Retour à l'équipe</a>
        </div>
        ...
        <?php if (empty($criteres)): ?>
            <div class="panneau">
                <p class="texte-vide">Aucun critère actif n'est défini pour le poste "<?= htmlspecialchars($employeCible['poste']) ?>".</p>
            </div>
        <?php else: ?>
            <div class="panneau">
                ...
                <form method="POST" action="">
                    ...
                    <div class="actions-formulaire">
                        <a href="equipe.php" class="bouton-secondaire">Annuler</a>
